...
export const ZERO_ANIMATIONS = {
    ...
    attack: { loop: false, frames: [
        {sx:63, sy:709, sw:40, sh:44, dur:1},
        {sx:111, sy:710, sw:38, sh:44, dur:1, ox:1},
        ...
        {sx:474, sy:703, sw:82, sh:52, dur:3, ox:23, atkBox:{w:44,h:33,ox:42,oy:-3}},
        ...
        {sx:771, sy:714, sw:46, sh:40, dur:1, ox:5},
        {sx:823, sy:714, sw:42, sh:40, dur:1, ox:3},
    ] },
    attack2: { loop: false, frames: [
        {sx:871, sy:777, sw:48, sh:39, dur:3, ox:6},
        {sx:807, sy:776, sw:58, sh:41, dur:3, ox:11},
        ...
        {sx:331, sy:776, sw:46, sh:43, dur:1, ox:-2},
        {sx:278, sy:774, sw:42, sh:43, dur:1},
        {sx:224, sy:773, sw:40, sh:43, dur:1, ox:1},
    ] },
    attack3: { loop: false, frames: [
        {sx:152, sy:839, sw:42, sh:43, dur:1, ox:-1},
        {sx:250, sy:839, sw:40, sh:44, dur:1},
        ...
        {sx:65, sy:896, sw:44, sh:38, dur:1, ox:4},
        {sx:119, sy:896, sw:44, sh:38, dur:1, ox:4},
        {sx:173, sy:897, sw:44, sh:38, dur:1, ox:4},
        {sx:225, sy:894, sw:38, sh:41, dur:1, ox:1},
    ] },
    attack_air: { loop: false, frames: [
        {sx:417, sy:1020, sw:29, sh:64, dur:1},
        {sx:461, sy:1020, sw:38, sh:63, dur:1, ox:-1},
